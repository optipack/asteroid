...
public class KeyBinds {
    ...
    public static KeyMapping OPEN_GUI = new KeyMapping("key.asteroid.open-gui", InputConstants.Type.KEYSYM, InputConstants.KEY_RSHIFT, CATEGORY);
    public static KeyMapping OPEN_COMMANDS = new KeyMapping("key.asteroid.open-commands", InputConstants.Type.KEYSYM, InputConstants.KEY_PERIOD, CATEGORY);
